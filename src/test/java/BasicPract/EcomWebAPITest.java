...
import PojoPract.LoginRequest;
import PojoPract.LoginResponse;
import PojoPract.OrderDetail;
import PojoPract.Orders;
...
public class EcomWebAPITest
{
    public static void main(String[] args)
    {
       ...
       // Login to Ecommerce Webpage
        LoginRequest loginRequest = new LoginRequest();
        loginRequest.setUserEmail("meghasawant99@gmail.com");
        loginRequest.setUserPassword("Smile@9991");
...
//        loginRequest.setUserPassword("Iamking@000");
        ...
        RequestSpecification reqAddProduct = given().log().all().spec(addProductBaseReq).param("productName", "Laptop")
                ...
                .multiPart("productImage",new File("C:\\Megha\\API_Testing_Projects\\Scrrenshot\\AC_Laptop.png"));
