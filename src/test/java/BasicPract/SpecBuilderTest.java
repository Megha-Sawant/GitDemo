...
import PojoPract.AddPlace;
import PojoPract.Location;
...
public class SpecBuilderTest
{
    public static void main(String args[])
    {
        ...
        Response response= given().spec(req).body(p).when().post("/maps/api/place/add/json").then().spec(resp).extract().response();
